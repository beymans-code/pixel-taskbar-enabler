package dev.beyman.pixeltaskbarenabler.annotationprocessor;
...
import dev.beyman.pixeltaskbarenabler.annotations.ChildProcessModPack;
import dev.beyman.pixeltaskbarenabler.annotations.MainProcessModPack;
import dev.beyman.pixeltaskbarenabler.annotations.ModPackPriority;

@SupportedAnnotationTypes("dev.beyman.pixeltaskbarenabler.annotations.BaseModPack")
...
public class AnnotationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        ClassName modPackData = ClassName.get("dev.beyman.pixeltaskbarenabler.annotations", "ModPackData");
        ...
        JavaFile javaFile = JavaFile.builder("dev.beyman.pixeltaskbarenabler.xposed", modPacksClass)
                .build();
